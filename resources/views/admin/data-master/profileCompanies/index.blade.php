<x-layout-panel>
    <div class="w-full">
        ...
        <x-bladewind::card class="w-full relative overflow-x-auto">
            <div class="w-full flex items-center justify-start flex-wrap gap-3 mb-10">
            ...
            <form method="post" action="{{ route('profile-companies.update', $data->id) }}" class="update-form w-full flex flex-col items-start justify-start gap-5 mb-3"
                ...
                <div class="w-full flex items-start justify-start flex-wrap md:flex-nowrap gap-5 -translate-y-3">
