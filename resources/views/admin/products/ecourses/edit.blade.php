...
<x-layout-panel>
    <div class="w-full">
        ...
        <h1 class="text-2xl font-bold mb-5">Perbarui E-Course</h1>
        <div class="w-full flex items-start justify-between gap-5 flex-wrap">
            ...
            <form method="post" action="{{ route('e-courses.update', $data->code) }}"
                class="update-form flex flex-col items-start justify-start gap-5 flex-1 create-form"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <x-bladewind::card title="Tambahkan informasi mengenai E-Course" class="w-full relative">
                ...
                <x-bladewind::card title="Jelaskan tentang E-Course" class="w-full relative">
