...
<x-layout-panel>
    <div class="w-full">
        ...
        <h1 class="text-2xl font-bold mb-5">Tambah E-File Baru</h1>
        <div class="w-full flex items-start justify-between gap-5 flex-wrap">
            ...
            <form method="post" action="{{ route('e-files.store') }}"
                class="flex flex-col items-start justify-start gap-5 flex-1 create-form"
                enctype="multipart/form-data">
                @csrf
                <x-bladewind::card title="Tambahkan informasi mengenai E-File" class="w-full relative">
                ...
                <x-bladewind::card title="Jelaskan tentang E-File" class="w-full relative">
