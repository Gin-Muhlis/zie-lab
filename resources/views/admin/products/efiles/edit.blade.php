...
<x-layout-panel>
    <div class="w-full">
        ...
        <h1 class="text-2xl font-bold mb-5">Perbarui E-File</h1>
        <div class="w-full flex items-start justify-between gap-5 flex-wrap">
            ...
            <form method="post" action="{{ route('e-files.update', $data->code) }}"
                ...
                <x-bladewind::card title="Tambahkan link download E-File" class="w-full relative">
                    <x-bladewind::input name="link_gdrive" label="Link download" selected_value="{{ old('link_gdrive') ?? $data->link_gdrive }}" />
                </x-bladewind::card>
