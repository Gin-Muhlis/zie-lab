<div class="container px-5 py-28">
    <div class="flex items-center justify-between gap-10 flex-col md:flex-row mb-28">
        <div>
            <h2 class="color-primary text-3xl md:text-4xl mb-5 font-lato text-primary font-bold">
                Zie Lab
            </h2>
            <p class="font-inter text-md leading-8 w-full">
                Platform edukasi yang menyediakan e-book, e-course, dan e-file berkualitas. Kami menawarkan berbagai materi edukatif, dari dasar hingga lanjutan.
            </p>
        </div>
    ...
    <div class="flex items-center justify-between gap-10 flex-col-reverse md:flex-row">
        ...
        <div>
            <h2 class="color-primary text-3xl md:text-4xl mb-5 font-lato text-black font-bold">
                Belajar Tanpa Batas
            </h2>
            <p class="font-inter text-md leading-8 w-full">
