<div class="w-full py-28 bg-white" id="products">
    <div class="container px-5 md:px-0 py-28">
        ...
        <x-list-category :categories="$categories" :filterCategory="$filterCategory"></x-list-category>
        ...
        <div class="text-center">
            <a href="{{ route('products.list') }}" class="text-primary text-md hover:underline">Lihat Semua Produk
                Digital</a>
        </div>
    </div>
</div>
...
@push('scripts')
    <script>
        $(function() {
            // pagination produk gerak ke kiri
            ...
            // pagination produk gerak ke kanan
